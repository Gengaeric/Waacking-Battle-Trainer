document.addEventListener("DOMContentLoaded", async () => {
  ...
  const translations = {
    es: {
      ...
      currentPlaylistSource: "Origen de la playlist actual",
      currentPlaylistSourceHelper: "Elige el correcto para que funcione.",
    ...
    en: {
      ...
      currentPlaylistSource: "Current playlist source",
      currentPlaylistSourceHelper:
        "Pick the correct one so the app works.",
      playlistSourceSpotify: "Spotify",
      playlistSourceYoutube: "YouTube",
